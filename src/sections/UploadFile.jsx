...
function UploadFile() {
  ...
  return (
    <div className="bg-gray-100 p-8 rounded-lg shadow-md">
      <h2 className="text-2xl font-bold mb-4">Hola, Cesar</h2>
      <p className="text-gray-600 mb-6">
        Seleccione el nombre del proveedor del cual desea procesar documentos. A
        continuación, elija el archivo PDF desde su equipo utilizando el botón
        'Examinar'. Finalmente, presione 'Procesar' para iniciar la
        digitalización.
      </p>
        ...
        {currentStep === 1 && (
          <div className="bg-white p-4 rounded-lg shadow-sm">
            <h3 className="text-lg font-bold mb-2">
              1. Seleccionador de multimedia
            </h3>
            <button
              onClick={() => handleMediaSelection('audio')}
              className={`px-4 py-2 rounded-md border ${
                selectedMedia === 'audio' ? 'bg-blue-500 text-white' : 'bg-gray-200'
              }`}
            >
              Audio
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-md border ${
                selectedMedia === 'video' ? 'bg-blue-500 text-white' : 'bg-gray-200'
              }`}
            >
              Video
            </button>
